...
export default function Accounts() {
  ...
  return (
    <div className="space-y-5 animate-slide-up">
      ...
      <PageGuide id="accounts-guide" emoji="🎮" title="📖 Инструкция: Мои аккаунты" sections={[
        {
          icon: '🎯', heading: 'Для чего эта страница',
          text: 'Здесь вы добавляете Steam-аккаунты, от имени которых бот будет публиковать объявления на форумах Steam.',
        },
        {
          icon: '➕', heading: 'Как добавить аккаунт',
          steps: [
            { title: 'Нажмите «Добавить аккаунт»', desc: 'откроется окно входа в Steam' },
            { title: 'Выберите способ входа', desc: 'QR-код (быстрее и надёжнее) или логин/пароль + Steam Guard' },
            { title: 'Бот сохранит сессию', desc: 'аккаунт появится в списке и будет готов к постингу' },
          ],
        },
        {
          icon: '📦', heading: 'Альтернативный способ: Импорт cookies',
          text: 'Если у вас есть JSON-файл с cookies Steam-сессии, нажмите «Импорт cookies» и выберите файл.',
        },
        {
          icon: '⚠️', heading: 'Важно знать',
          items: [
            { label: 'Сессия может истечь', desc: 'если аккаунт стал неактивным — нажмите кнопку обновления и перезайдите' },
            { label: 'Лимит аккаунтов', desc: 'зависит от вашего тарифа (видно в шапке страницы)' },
            { label: 'Удаление', desc: 'нажмите корзину на карточке аккаунта, чтобы удалить его' },
          ],
          tip: 'Рекомендуем QR-код — он не требует ввода пароля и работает быстрее.',
        },
      ]} />
