      ...
      <PageGuide id="campaigns-guide" emoji="📢" title="📖 Инструкция: Автопостинг" sections={[
        ...
        },
        {
          ...
          steps: [
            ...
            { title: 'Выберите форум/группу', desc: 'где публиковать — CS2, Dota 2, TF2 и другие' },
            { title: 'Создайте пост', desc: 'сгенерируйте из инвентаря (кнопка «Сгенерировать») или напишите свой' },
            { title: 'Укажите время', desc: 'добавьте время публикации (минимум 60 минут между постами)' },
          ],
        },
        {
        ...
        {
          icon: '💡', heading: 'Переменные шаблона',
          text: 'В заголовке и теле поста можно использовать переменные, которые бот автоматически подставит:',
          items: [
            { label: '{items_count}', desc: 'кол-во предметов в инвентаре' },
            { label: '{best_item}', desc: 'лучший предмет' },
            { label: '{trade_url}', desc: 'ваша ссылка для обмена' },
            { label: '{date}, {time}', desc: 'дата и время публикации' },
            { label: '{full_inventory_post}', desc: 'готовый пост с авто-разметкой' },
          ],
          tip: 'Самый простой способ — нажать «Сгенерировать из инвентаря» — бот сам составит пост.',
        },
      ]} />
