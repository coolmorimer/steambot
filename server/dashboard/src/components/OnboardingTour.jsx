...
const STEPS = [
  {
    ...
    body: 'Давайте покажем как всё работает за 4 простых шага. Это займёт меньше минуты!',
    emoji: '🚀',
    position: 'center',
    route: '/',
  },
  {
    ...
    title: '🏠 Главная',
    body: 'Это ваша главная страница. Здесь видно сколько аккаунтов подключено, сколько постов опубликовано и какой у вас тариф.',
    emoji: '🏠',
    position: 'right',
    route: '/',
  },
  {
    ...
    title: '🎮 Мои аккаунты',
    body: 'Сначала добавьте сюда Steam-аккаунт. Можно через QR-код или логин/пароль. Бот будет публиковать посты от имени этого аккаунта.',
    emoji: '🎮',
    position: 'right',
    route: '/',
  },
  {
    ...
    title: '📢 Автопостинг',
    body: 'Здесь вы создаёте задачу — это шаблон поста, который бот будет автоматически публиковать на форумах Steam.',
    emoji: '📢',
    position: 'right',
    route: '/',
  },
  {
    ...
    title: '📋 История',
    body: 'Все публикации отображаются здесь: успешные, ошибки, в очереди. Можно понять что работает, а что нет.',
    emoji: '📋',
    position: 'right',
    route: '/',
  },
  {
    ...
    title: '🔄 Обмен скинами',
    body: 'Обменивайте скины CS2 с другими пользователями напрямую через Steam.',
    emoji: '🔄',
    position: 'right',
    route: '/',
  },
  {
    ...
    title: '💎 Тариф',
    body: 'Выберите подходящий тариф и оплатите. Чем выше — тем больше аккаунтов и постов в день.',
    emoji: '💎',
    position: 'right',
    route: '/',
  },
  {
    ...
    body: 'Добавьте Steam-аккаунт → создайте задачу автопостинга → бот сделает остальное! Подсказки есть на каждой странице — ищите 💡.',
    emoji: '🎉',
    position: 'center',
    route: '/',
    isFinal: true,
