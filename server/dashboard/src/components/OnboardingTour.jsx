...
const STEPS = [
  ...
  },
  {
    ...
    title: '✅ Задачи',
    body: 'Создайте задачу — это шаблон публикации + расписание. Бот сам будет публиковать объявления на форумах Steam.',
    emoji: '📢',
    position: 'right',
    route: '/',
  },
  ...
  },
  {
    ...
    title: '💎 Подписка',
    body: 'Выберите тариф и оплатите подписку. Чем выше тариф — тем больше аккаунтов, задач и функций.',
    emoji: '💎',
    position: 'right',
    route: '/',
  },
  {
    ...
    body: 'Начните с привязки Steam-аккаунта и создания первой задачи. Если нужна помощь — нажмите кнопку поддержки внизу справа.',
    emoji: '🎉',
    position: 'center',
    route: '/',
    isFinal: true,
